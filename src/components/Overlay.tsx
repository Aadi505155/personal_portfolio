    ...
    <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-center text-white mix-blend-difference">
        ...
        >
            <div className="text-center">
                <h1 className="text-6xl md:text-8xl font-bold tracking-tight mb-4">Aditya Bisht.</h1>
                <p className="text-xl md:text-2xl font-light text-gray-300">Full Stack Developer | Tech Enthusiast.</p>
            </div>
        </motion.div>
        ...
        >
            <div className="max-w-2xl">
                <h2 className="text-5xl md:text-7xl font-bold leading-tight">Transforming ideas into <br/><span className="text-blue-500">digital solutions</span> through code.</h2>
            </div>
        </motion.div>
        ...
        >
            <div className="max-w-2xl">
                <h2 className="text-5xl md:text-7xl font-bold leading-tight">B.Tech CSE Student <br/><span className="text-purple-500">passionate about tech</span>.</h2>
            </div>
        </motion.div>
    </div>
  );
